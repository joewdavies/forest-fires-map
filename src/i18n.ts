...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    legend_last_30_days: "Last 30 days",
    legend_burnt_area: "Burnt area",
    legend_borders: "Country Borders",
    legend_active_fires_via_firms: "via NASA FIRMS",
    legend_active_fires_via_effis: "via EU EFFIS",
    legend_burnt_areas_via_effis: "via EU EFFIS",
  ...
  es: {
    ...
    legend_last_30_days: "Últimos 30 días",
    legend_burnt_area: "Área quemada",
    legend_borders: "Límites nacionales",
    legend_active_fires_via_firms: "vía NASA FIRMS",
    legend_active_fires_via_effis: "vía UE EFFIS",
    legend_burnt_areas_via_effis: "vía UE EFFIS",
    ...
    active_fires_source_effis: "UE",
    active_fires_source_firms: "NASA",
    active_fires_source_tooltip: "UE = EFFIS, NASA = FIRMS",
  ...
  de: {
    ...
    legend_last_30_days: "Letzte 30 Tage",
    legend_burnt_area: "Brandfläche",
    legend_borders: "Landesgrenzen",
    legend_active_fires_via_firms: "über NASA FIRMS",
    legend_active_fires_via_effis: "über EU EFFIS",
    legend_burnt_areas_via_effis: "über EU EFFIS",
  ...
  fr: {
    ...
    legend_last_30_days: "30 derniers jours",
    legend_burnt_area: "Zone brûlée",
    legend_borders: "Frontières nationales",
    legend_active_fires_via_firms: "via NASA FIRMS",
    legend_active_fires_via_effis: "via UE EFFIS",
    legend_burnt_areas_via_effis: "via UE EFFIS",
